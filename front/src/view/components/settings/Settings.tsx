...
function Settings() {
	...
	const setProperty = React.useCallback(
		<T extends keyof UserSettingsModel>(key: T) =>
			(val: any) => {
				setNewSettings({
					...newSettings,
			...
			<Grid container direction={"column"} alignItems={"center"} spacing={6}>
				...
				<Grid item xs={12}>
					<FormControl fullWidth>
						...
						<Select labelId="settings-theme-label" id="settings-theme-select" value={newSettings.theme} label="Theme" fullWidth onChange={setProperty("theme")}>
